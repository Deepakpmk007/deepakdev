...
export default function Work() {
  return (
    <div className="w-full h-fit py-40 md:py-48 px-10 md:px-38 flex flex-col relative bg-[#669bbc]">
      <h1>
      ...
      <Link
        href={"/work"}
        className="top-20 left-5 w-fit mt-15 font-light font-playwrite text-lg md:text-2xl flex gap-3 items-center justify-center cursor-pointer py-2 px-3 backdrop-blur-none hover:backdrop-blur-md transition duration-300 rounded-lg"
      >
        View All work
      </Link>
    </div>
